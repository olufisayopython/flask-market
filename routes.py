    ...
    if request.method == 'POST':
        ...
        if p_item_object:
            if current_user.can_purchase(p_item_object):
                ...
                flash(f"Unfortunately!!! you dont have enough money to purchase {p_item_object.name}, please fund your wallet and try again", category="danger")
        ...
        if s_item_object:
            if current_user.can_sell(s_item_object):
                ...
                flash(f"error!!! something went wrong selling {s_item_object.name}", category="danger")
